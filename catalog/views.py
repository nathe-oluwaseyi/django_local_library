...
def  index(request):
    ...
    particular_book = Book.objects.filter(title__icontains='python')
    num_particular_book = particular_book.count()
    ...
    context = {
        ...
        'num_particular_book': num_particular_book,
...
@login_required
@permission_required('catalog.car_mark_returned', raise_exception=True)
