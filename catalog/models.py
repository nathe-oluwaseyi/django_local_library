...
class Book(models.Model):
    ...
    # Author is a string rather than an object because it hasn't been declared yet
    # in the file.
    ...
    def display_genre(self):
        '''Create a string for the Genre. This is to display genre in Admin.'''
...
class Language(models.Model):
    '''Model representing a language(e.g. French, Spanish etc).'''
    name = models.CharField(
        max_length=200,
        help_text='Enter the book\'s natural language (e.g. English, Japanese, French etc.',
    )
